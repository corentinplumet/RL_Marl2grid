...
Usage:
  ...
  sbatch Topology_Task/full_test_eval/job_full_test_eval.sh --checkpoint checkpoint/best_test_run.tar
  sbatch Topology_Task/full_test_eval/job_full_test_eval.sh --model run_name --step 15000000
