#!/usr/bin/env bash
# EPFL JED launcher for pure do-nothing evaluation.
# Submit from the repository root, for example:
#   ENV_ID=bus36 MAX_EPISODES=10 \
...
Common overrides:
  ...
  OUTPUT_DIR=outputs/do_nothing_eval/bus36_test
  PROGRESS=true
...
echo "Launching do-nothing evaluation on JED"
