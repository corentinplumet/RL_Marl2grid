...
# Submit the flat-MLP-actor WCCI from-scratch baseline on JED.
# Generated by tools/generate_wcci_mlp_scratch_configs.py.
# Usage: bash configs/no_leakage_config/V_wcci_mlp_scratch/launch_jed.sh [filters...]
...
task_config_dir="configs/no_leakage_config/V_wcci_mlp_scratch"
