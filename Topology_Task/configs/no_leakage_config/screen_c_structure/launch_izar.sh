...
config_dir="Topology_Task/configs/no_leakage_config/screen_c_structure"
filters=("$@")
submitted=0
...
echo "$( is_true "${DRY_RUN:-false}" && echo Validated || echo Submitted) $submitted runs for screen_c_structure."
