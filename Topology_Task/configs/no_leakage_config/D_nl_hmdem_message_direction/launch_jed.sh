#!/usr/bin/env bash
# Screen D rerun with the selected GNN architecture, seed 0, on JED.
...
echo "$( is_true "${DRY_RUN:-false}" && echo Validated || echo Submitted) $submitted runs for nl_hmdem_message_direction on JED."
