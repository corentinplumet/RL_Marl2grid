#!/usr/bin/env bash
# Submit the matched seed-0 NLS WCCI mk64 scratch/fine-tuning campaign.
...
task_config_dir="configs/no_leakage_config/W_wcci_cas_hl_shared_mk64_seed0"
...
print("Validated mk64 action space: " + ", ".join(
...
echo "========== NLS WCCI mk64 seed-0 campaign =========="
...
if [[ $selected -eq 0 ]]; then
  ...
  echo "Examples: ft64c  sc64c  mean_f0_a0h0  tmean" >&2
  exit 1
fi
