#!/usr/bin/env bash
# Screen C rerun with the selected GNN architecture, seed 0, on JED.
...
echo "$( is_true "${DRY_RUN:-false}" && echo Validated || echo Submitted) $submitted runs for nl_s2em_structure on JED."
