#!/usr/bin/env bash
# Submit the WCCI-from-scratch architecture screen.
# Usage: bash configs/no_leakage_config/X_wcci_scratch_arch/launch_izar.sh [filters...]
...
echo "========== WCCI from-scratch architecture screen =========="
