...
# Usage: bash configs/no_leakage_config/H_encoder_transfer_bridge/launch_izar.sh [filters...]
...
task_config_dir="configs/no_leakage_config/H_encoder_transfer_bridge"
...
echo "========== Chapter 9 encoder-only transfer =========="
