...
These 18 configs repeat the no-validation MLP train/test setup for seeds 0, 1, and 2.
...
```bash
sbatch job_jed.sh configs/noval_seed_sweep/noval20_mlp_a1_entropy_decay_s0_det.toml
sbatch job_jed.sh configs/noval_seed_sweep/noval20_mlp_a1_entropy_decay_s0_stoch.toml
...
sbatch job_jed.sh configs/noval_seed_sweep/noval20_mlp_a3_entropy_decay_s0_det.toml
sbatch job_jed.sh configs/noval_seed_sweep/noval20_mlp_a3_entropy_decay_s0_stoch.toml
...
sbatch job_jed.sh configs/noval_seed_sweep/noval20_mlp_a4_entropy_decay_s0_det.toml
sbatch job_jed.sh configs/noval_seed_sweep/noval20_mlp_a4_entropy_decay_s0_stoch.toml
...
Everything not listed here is intentionally kept identical across the 18 runs.
