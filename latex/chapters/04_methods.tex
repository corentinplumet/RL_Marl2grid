...
In addition to physical-line relations, the graph may include a directed
same-substation edge $i(s,b)\rightarrow i(s,b')$ for every $b\neq b'$.
These relations remain active throughout the episode and use zero physical-line
features except for the neutral value \texttt{rho}$=1$. Same-substation edges
permit message passing between alternative busbars but do not represent an
