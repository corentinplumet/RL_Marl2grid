...
\section{WCCI Action-Space Reduction}
\label{sec:wcci-action-space-reduction}

The WCCI bus36 setting has a much larger discrete topology-action space than
bus14. Before training MAPPO on this environment, the action space is reduced
offline from simulated action outcomes. During rollouts, states are collected
...
available reduced actions and executes the best improving one.
...
\begin{table}[htbp]
  ...
  \begin{tabular}{L{0.30\textwidth}L{0.28\textwidth}rrrr}
    ...
    \midrule
    Do-nothing reference & \(1,1,1,1\) & -- & 36.35 & -- & -- \\
    WCCI \(h=1\), \texttt{mk256} & \(77,256,127,256\) & 69.43 & 36.35 & 33.08 & 56.00 \\
    WCCI \(h=1\), \texttt{mk512} & \(77,512,127,512\) & 65.46 & 36.35 & 29.11 & 48.00 \\
    WCCI \(h=1\), \texttt{mk1024} & \(77,1024,127,1024\) & 74.39 & 36.35 & 38.03 & 64.00 \\
    \bottomrule
  \end{tabular}
  }
\end{table}
