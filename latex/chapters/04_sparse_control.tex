...
non-idle action penalties, and adaptive intervention budgets.
\\
\\
...
\\
\\
A complementary 15-run flat-actor ablation separates fixed versus adaptive coefficients,
...
\paragraph{Full-test evaluation.}
...
The main performance metric remains episodic survival, paired with the mean
action-0 fraction across agents. Detailed sparsity and physical-diagnostic
metrics (e.g., budget multipliers, topology-distance changes) are deferred to
