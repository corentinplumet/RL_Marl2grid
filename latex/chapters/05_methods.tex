...
{\color{red}
\noindent\textbf{Checkpoint compatibility.}
The \texttt{cas\_hl\_NL} and \texttt{cas\_hl\_NLS} checkpoints were trained
with the former 13-column line-node feature schema, which still included the
redundant \texttt{connected} feature. The current schema has 12 columns;
full-test evaluation detects these checkpoints and restores the legacy column,
thereby preserving their original input representation.
}
