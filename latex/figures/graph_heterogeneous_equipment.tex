...
\node[title] at (6.3,5.02) {Disaggregated equipment graph};
...
\node[muted] at (4.10,4.15)
  {equipment remains individually addressable};

% Compact legend.
\node[busbar, minimum size=5.2mm] at (1.25,0.48) {};
\node[note, anchor=west] at (1.57,0.48) {busbar};
\node[generator, minimum size=5.2mm] at (3.55,0.48) {$G$};
\node[note, anchor=west] at (3.87,0.48) {generator};
\node[load, minimum size=5.2mm] at (6.12,0.48) {$L$};
\node[note, anchor=west] at (6.44,0.48) {load};
\draw[physical] (8.28,0.48) -- (9.04,0.48);
\node[note, anchor=west] at (9.22,0.48) {active relation};
